...
if __name__ == '__main__':
    ...
    parser.add_argument("--droid-ckpt", type=str, default='./weights/droid.pth',
                        help="DROID-SLAM checkpoint file")

    # mesh reconstruction
    parser.add_argument("--voxel-length", type=float, default=0.02, help="voxel length")
    parser.add_argument("--smp-decimation", type=int, default=0, help="target number of triangles")

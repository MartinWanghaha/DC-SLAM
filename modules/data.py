...
class PosedImageStream(Dataset):
    """Dataset for loading RGB images with optional depth maps and poses."""
    ...
    def __init__(
        ...
        if traj_dir is None and traje_dir is not None:
            traj_dir = traje_dir
